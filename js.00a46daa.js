...
var Song = exports.default = /*#__PURE__*/_createClass(function Song(k_song, v_song) {
...
exports.default = void 0;
var _Song = _interopRequireWildcard(require("./Song.js"));
...
var player = exports.default = /*#__PURE__*/_createClass(function player(map) {
  ...
  for (var _i = 0, _Object$entries = Object.entries(map); _i < _Object$entries.length; _i++) {
    ...
    var clave = key;
    var valor = value;
    var song = new _Song.default(clave, valor);
    (0, _Song.play_song)(song);
    aux++;
  }
});
},{"./Song.js":"js/Song.js"}],"js/index.js":[function(require,module,exports) {
"use strict";
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33487" + '/');
